...
describe(getName(), () => {
  ...
  describe('find()', () => {
    ...
    it('matches on specific github path', () => {
      add({
        hostType: PLATFORM_TYPE_GITHUB,
        matchHost: 'https://api.github.com',
        token: 'platformTokenFromPlatformConfig',
      });
      add({
        hostType: PLATFORM_TYPE_GITHUB,
    ...
    it('does not match when no specific host type for github request is configured', () => {
      add({
        hostType: PLATFORM_TYPE_GITHUB,
        matchHost: 'https://api.github.com',
        token: 'platformTokenFromPlatformConfig',
      ...
      ).toEqual('platformTokenFromPlatformConfig');
    });
